...
class Model(nn.Module):
    def __init__(self, num_bats, num_pits, num_teams, emb_dim, dropout, device):
        ...
        # Policy output
        self.bat_dest = nn.Linear(2048, 5)
        self.run1_dest = nn.Linear(2048, 5)
        self.run2_dest = nn.Linear(2048, 5)
        self.run3_dest = nn.Linear(2048, 5)
